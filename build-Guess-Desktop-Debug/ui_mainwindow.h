...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        number->setGeometry(QRect(10, 0, 161, 31));
        ok = new QPushButton(centralWidget);
        ok->setObjectName(QStringLiteral("ok"));
        ok->setGeometry(QRect(190, 0, 84, 32));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        output->setText(QApplication::translate("MainWindow", "Insert a number between 0and 10", 0));
    } // retranslateUi
